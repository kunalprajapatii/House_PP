# -*- coding: utf-8 -*-
"""
Created on Sat Jan 20 23:06:49 2018
...
def implement():
    ...
    elastReg=linear_model.ElasticNet(alpha=0.001,l1_ratio=0.7,max_iter=100000,fit_intercept=True)
    elastReg.fit(X_train,y_train)
    print("Score of Elastic Net Regression: %.2f" % elastReg.score(X_test,y_test))
